...
function Web() {
  return (
    <>
      ...
      {/* ---- */}
      <h1 className="text-black text-center text-2xl md:text-3xl font-bold pt-12 md:pt-12">
      Current Openings
      </h1>
      ...
      <div className="mt-[2rem] md:mt-[5rem]">
        ...
        <div className="flex flex-col gap-3">
          ...
          <ul className="flex justify-between w-full flex-col text-center md:flex-row md:text-start ">
            {/* class name */}
            <li className="py-[25px] px-[55px] bg-[#f2f2f2] w-full text-center">
            ...
            <li className="bg-[#f2f2f2] w-full flex justify-center items-center pb-4 text-center">
              <a
